    ...
    return (
        <div className={styles.container}>
            <p className={styles.description}>
                ...
                I have 2 years of professional experience working as a Software Engineer, I'm looking for a new role and I'm working on a collection of poems that I hope to publish soon.<br />
